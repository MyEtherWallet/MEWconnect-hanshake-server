...
let createdSignature = document.getElementById("createdSignature");
...
function initiateSocketConnection() {
    ...
    // urlBase = "127.0.0.1";
    mewConnect.initiatorCall(`https://${urlBase}:3001`);
}
...
document.addEventListener("codeDisplay", function (event) {
