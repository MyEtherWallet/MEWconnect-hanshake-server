class MewRTC {
    ...
    randombytes(arg) {
        return CCrypto.crypto.randomBytes(arg);
    }
    ...
    setSelectedCandidatePair(selectedCandidatePair, localCandidates, remoteCandidates) {
        ...
        console.log(selectedCandidatePair, localCandidates, remoteCandidates);  //todo remove debug item
        if (local && local.ip) {
            // Spec
    ...
    signal(data) {
        ...
        if (data.sdp) {
            this._pc.setRemoteDescription(new (this._wrtc.RTCSessionDescription)(data), () => {
                console.log("setRemoteDescription", this);
                if (this.destroyed) return;
    ...
    _onChannelMessage(event) {
        ...
        console.log(event); //todo remove debug item
...
// See: https://github.com/nodejs/readable-stream/issues/283
    ...
    _destroy(err, cb) {
        ...
        // console.log(this.readableStream);
